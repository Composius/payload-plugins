...
| [@vitrailweb/payload-plugin-custom-panel](packages/payload-plugin-custom-panel) | 0.1.1 | Configurable panel (site title, message, link buttons) above the admin dashboard |
