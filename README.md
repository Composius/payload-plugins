...
| [@composius/payload-plugin-redirections](packages/payload-plugin-redirections) | 0.1.1 | Redirections collection with exact, prefix and regex URL matching, plus a Next.js proxy helper |
