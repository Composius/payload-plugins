...
| -------------------------------------------------------------------- | ------- | ---------------------------------- |
| [@composius/payload-plugin-articles](packages/payload-plugin-articles) | 1.10.0 | Articles and categories collections with drafts, live preview, and SEO |
...
| [@composius/payload-plugin-media](packages/payload-plugin-media)       | 1.2.0 | Configurable media uploads collection (access, unique filenames, storage prefix, image sizes) |
| [@composius/payload-plugin-menus](packages/payload-plugin-menus)       | 1.3.0 | Menus collection                   |
| [@composius/payload-plugin-pages](packages/payload-plugin-pages)       | 2.2.1 | Pages collection with drafts, live preview, and SEO |
