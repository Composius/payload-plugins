...
| [@composius/payload-plugin-media](packages/payload-plugin-media)       | 1.1.1 | Configurable media uploads collection (access, unique filenames, storage prefix, image sizes) |
