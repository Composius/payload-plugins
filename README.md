...
| [@composius/payload-plugin-media](packages/payload-plugin-media)       | 1.1.2 | Configurable media uploads collection (access, unique filenames, storage prefix, image sizes) |
| [@composius/payload-plugin-menus](packages/payload-plugin-menus)       | 1.3.0 | Menus collection                   |
| [@composius/payload-plugin-pages](packages/payload-plugin-pages)       | 2.2.0 | Pages collection with drafts, live preview, and SEO |
