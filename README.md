...
| -------------------------------------------------------------------- | ------- | ---------------------------------- |
| [@composius/payload-plugin-articles](packages/payload-plugin-articles) | 1.3.0 | Articles and categories collections with drafts, live preview, and SEO |
| [@composius/payload-plugin-auth](packages/payload-plugin-auth)         | 1.0.2 | Users auth collection with configurable roles and role-based access helpers |
