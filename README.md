...
| [@composius/payload-plugin-redirections](packages/payload-plugin-redirections) | 1.0.0 | Redirections collection with exact, prefix and regex URL matching, plus a Next.js proxy helper |
